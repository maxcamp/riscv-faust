...
class InstructionCounterAspect (tree: Tree) extends Aspect (tree){
  ...
  before(moduleCreationJoinpoint , q"val instCounts = Module(new InstructionCounters)")

  after(ioConnectionJoinpoint, q"instCounts.io.inst := ew_inst")
}
...
object TransformerMain extends App {
  ...
  val dir = "/home/whytheam/Research/chisel/riscv-mini/src/main/scala"
